...
////// Emissive:
                ...
                float node_387 = pow(saturate(((length((i.uv0.r*1.0+-0.5))*2.0+0.0)-_radialfog)),_radialfogpower);
                float node_4061 = (1.0+node_387);
                float node_4104 = saturate((node_4061*saturate((sceneZ-partZ)/_depth)));
